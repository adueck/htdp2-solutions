...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex-467) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (triangulate M)
  (if (<= (length (first M)) 2)
      ...
      (local ((define topE (first M))
              (define lowerEs (avoid-top-zero (rest M)))
