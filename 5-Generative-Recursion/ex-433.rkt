...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex-433) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (bundle s n)
  (cond
    [(empty? s) '()]
    [(= n 0) (error "can't have bundle chunk size = 0 with non-empty [List-of 1String]")]
    [else
