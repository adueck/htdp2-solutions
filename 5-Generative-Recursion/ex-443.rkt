...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex-443) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
; taken from https://gitlab.com/cs-study/htdp/-/blob/main/05-Generative-Recursion/26-Designing-Algorithms/Exercise-443.rkt
