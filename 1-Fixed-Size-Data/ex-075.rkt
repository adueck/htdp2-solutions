...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-075) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; Posn Vel -> Posn
; adds v to p
(check-expect (posn+ (make-posn 1 2) (make-vel 2 3))
              (make-posn 3 5))
