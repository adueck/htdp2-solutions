...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-062) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; DoorState -> DoorState
; closes an open door after a period of one tick
