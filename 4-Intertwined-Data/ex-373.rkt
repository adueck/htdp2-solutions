...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname ex-373) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require 2htdp/image)
...
(define (count-hellos xe)
  (local
    ((define content (xexpr-content e1)))
    (foldr for-item 0 content)))

; XItem.v2 Number -> Number
(check-expect (for-item
               '(li (word ((text "hello"))))
               1) 2)
(check-expect (for-item
               '(li (word ((text "foo"))))
