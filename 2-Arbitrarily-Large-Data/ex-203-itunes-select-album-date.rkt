...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex-203-itunes-select-album-date) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
