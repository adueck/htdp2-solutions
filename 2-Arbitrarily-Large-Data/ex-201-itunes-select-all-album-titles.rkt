...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-201-itunes-select-all-album-titles) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
